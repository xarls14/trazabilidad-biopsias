<?php
   ...
   /*------------INCLUDES-----------------*/
   include '../config.php';
   include '../modal/modalNuevoPacienteAdmin.php';
   //include '../modal/modalActualizarpacienteAdmin.php';
   include '../modal/modalActualizarpacientesAdmin.php';
   include '../modal/ModalCrearUsuario.php';
   include '../modal/modalCambiarPassword.php';
      ...
      <div class="wrapper">
         ...
         <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
               <li>
                  <a href="../administrador/welcome.php">Listar muestras</a>
               </li>
               <li>
                  <a href="../administrador/ListarPacientesAdmin.php">Listar pacientes</a>
               </li>
            </ul>
         </nav>
         <!-- Page Content  -->
         <div id="content">
               ...
               <div class="col-sm-1 float-right">
                  <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a data-toggle="modal" data-target="#myModalCrearUsuario" style="cursor: pointer;">
                        <i class="fas fa-user-plus"></i><span> Nuevo Usuario</span></a> 
                        <!--<a data-toggle="modal" data-target="#myModalActualizarCambiarPassword" style="cursor: pointer;"><i class="fas fa-key"></i> Cambiar Contraseña</a>-->
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     <ul class="nav navbar-nav ml-auto">
                        <li class="nav-item active">
                           <!--<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModalNuevoPacienteAdmin">
            ...
            <div>
                <div id="tablaMuestra" class="display"></div>
            </div>
      </div>
   </body>
</html>
