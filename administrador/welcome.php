   ...
   <body>
      <div class="wrapper">
         ...
         <div id="content">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     <ul class="nav navbar-nav ml-auto">
                        <li class="nav-item active">
                           <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModalNuevoPacienteAdmin" data-backdrop="static" data-keyboard="false">
            ...
            <h2 style="margin-bottom: 30px;">Lista de muestras</h2>
            
            <!--<div>
               <input id="myInputBuscar" type="text" placeholder="Buscar muestras..." style="margin-bottom: 10px;">
            </div>-->
