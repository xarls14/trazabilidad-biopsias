      ...
      <div class="wrapper">
         ...
         <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
               <li>
                  <a href="#homeSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Recepción resultados</a>
                  <ul class="collapse list-unstyled" id="homeSubmenu">
                     <li>
                        <a href="../administrativo/welcomeRecepcionMuestraAprobadaHigueras.php">Recepción resultados desde laboratorio</a>
                     </li>
                  </ul>
               </li>
               <li>
                  ...
                  <ul class="collapse list-unstyled" id="pageSubmenu">
                     <li>
                        <a href="../administrativo/welcome.php">Listar todas las muestras</a>
                     </li>
                     <li>
                        <a href="../administrativo/welcomeListarMuestrasFinalizadas.php">Listar muestras finalizadas</a>
                     </li>
                  </ul>
               </li>
            </ul>
         ...
         <div id="content">
            ...
            <h2 style="margin-bottom: 30px;">Muestras finalizadas</h2>
...
<script type="text/javascript">
  ...
  actualizarTablaAdministrativoMuestrasFinalizadas();
});
</script>
