   ...
   <body>
      <div class="wrapper">
         ...
         <div id="content">
            ...
            <h2 style="margin-bottom: 30px;">Recepcionar resultados desde higueras</h2>
...
<script type="text/javascript">
   $(document).ready(function(){
    //ahora debemos mostrar muestras que estan en transito para luego pasar a recibido higueras
