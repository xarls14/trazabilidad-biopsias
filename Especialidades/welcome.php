      ...
      <div class="wrapper">
         ...
         <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
               <li>
                  <a href="../Especialidades/welcome.php">Listar muestras</a>
               </li>
               <li>
                  <a href="../Especialidades/welcomeListarPacientes.php">Listar pacientes</a>
               </li>
            </ul>
         </nav>
         <!-- Page Content  -->
         <div id="content">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     <ul class="nav navbar-nav ml-auto">
                        <li class="nav-item active">
                           <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModalNuevoPaciente" data-backdrop="static" data-keyboard="false">
            ...
            <h2 style="margin-bottom: 30px;">Listado muestras</h2>
